...
function pistaFunction(palabra){
    ...
    switch(palabra){   
        ...
        case 'GATO':
            ...
            break;
        case 'ALACRAN':
            pista = "Es muy letal si te pica";
            break;
        case 'ARAÑA':
            pista = "Tienen muchas patas y tienen un veneno muy letal";
            break;
        case 'CARACOL':
            pista = "Es un animal muy lento"
            break;
        case 'TIBURON':
            pista = "Es el rey del oceano"
            break;
        case 'MUSARAÑA':
            pista = "Es el mamífero más pequeño del mundo"
            break;
        case 'RINOCERONTE':
            pista = "Es el segundo mamifero terrestre de mayor tamaño"
            break;
        case 'OCELOTE':
            pista = "Es un felino de mediano tamaño"
            break;
        case 'CHAPULIN':
           pista = "Insecto comestible que comúnmente habita en areas de México"
           break;
        case 'AGUILA':
            pista = "Es una ave de presa"
            break;
        case 'LAGARTIJA':
            pista = "Son reptiles inofensivos"
            break;
        case 'AVESTRUZ':
            pista = "Es una gran ave que no vuela"
            break;
    }
